...
class EditQuizPage extends StatefulWidget {
  ...
  const EditQuizPage({super.key, required this.chapterId, required this.quizId});
...
class _EditQuizPageState extends State<EditQuizPage> {
  ...
  Future<void> _updateQuiz() async {
    ...
    try {
      ...
      await quizViewModel.updateQuiz(widget.chapterId, widget.quizId, updatedQuiz);
                      ...
                      Center(
                        child: ElevatedButton(
                          ...
                          child: _isUploading
                              ...
                              : const Text('Update', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w600)),
                        ),
                      ),
                    ],
                  ),
